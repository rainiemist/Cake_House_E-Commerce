...
if($result){
    ...
    for ($i = 0; $i< count($_SESSION['Cart']); $i++){ 
        $created_at= date('Y-m-d H:i:s');
        $sql= "INSERT INTO order_details (customer_orders_id, products_id, picture, name, price, quantity, created_at) VALUES (:customer_orders_id, :product_id, :picture, :name, :price, :quantity, :created_at)";
        $sth = $db ->prepare($sql);
                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <p class="text-center">您已成功完成購物，您可前往<a href="customer-orders.php">我的訂單</a>查詢出貨進度或<a href="products_list.php?cat=1">繼續購物</a></p>
