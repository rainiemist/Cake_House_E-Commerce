...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
    ...
    $sql= "UPDATE members SET `name`=:name, birthday=:birthday, gender=:gender, zipcode=:zipcode, country=:country, district=:district, phone=:phone, mobile=:mobile, email=:email, updated_at=:updated_at WHERE members_id=:members_id";
    $sth = $db ->prepare($sql);
...
<?php require_once('template/navbar.php'); ?>
 ...
 _________________________________________________________ -->
        ...
        <script src="../lib/TWzipcode/jquery.twzipcode.js"></script>
        <script>
        $(function(){
            $('#twzipcode').twzipcode({
