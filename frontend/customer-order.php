...
<?php require_once('template/navbar.php'); ?>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>訂單 No. <?php echo $member['order_no'];?></li>
                    </ul>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-order">
                    <div class="box">
                        <h1>訂單 No. <?php echo $member['order_no'];?></h1>

                        <p class="lead">訂單 No. <?php echo $member['order_no'];?> 於 <strong><?php echo $member['order_date'];?></strong> 成立，目前狀態為<strong>
                            ...
                            <table class="table">
                                ...
                                <?php foreach ($order_details as $customer_orders) { ?>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <a href="products.php?id=<?php echo $customer_orders['products_id'];?>">
                                                <img src="../uploads/products/<?php echo $customer_orders['picture'];?>" alt="">
                                            </a>
                                        </td>
                                        <td>
										<a href="products.php?id=<?php echo $customer_orders['products_id']; ?>"><?php echo $customer_orders['name'];?></a>
										</td>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="5" class="text-right"><b>訂單總計:</b></th>
                                       
                                        <th>$NT <?php echo $member['total_price'];?></th>
                                    </tr>
                                    <tr>
                                        <th colspan="5" class="text-right"><b>運費:</b></th>
                                        <th>$NT <?php echo $member['shipping'];?></th>
                                    </tr>
                                   
                                    <tr>
                                        <th colspan="5" class="text-right"><b>合計:</b></th>
                            ...
                            <div class="col-md-12">
                                <h2><b>收件者資訊</b></h2>
                                   <p><?php echo $_SESSION['member']['name'];?> 先生 / 小姐
                                    <br>
                                    <?php echo $_SESSION['member']['zipcode'].$_SESSION['member']['county'].$_SESSION['member']['district'].$member['address'];?>
                                    <br>
                                    H: <?php echo $_SESSION['member']['phone'] ?>
                                    <br>
                                    M: <?php echo$_SESSION['member']['mobile'] ?>
                                    <br>
                                    <br>
                                   <h3><b>備註說明:</b></h3> <h4> <?php echo $member['memo'];?> </h4>
                                 </p>
                            </div>
