                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">cakehouse@fakeemail.com</a></strong>
                                    </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" cols="10" id="phone" name="phone" 
                                        value="<?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) 
                                                            echo $_SESSION['member']['phone']; ?>">
                                        <input type="text" class="form-control" cols="10" id="mobile" name="mobile" 
                                        value="<?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) 
                                ...
                                <div class="col-sm-12 text-center">
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> 傳送訊息</button>
