...
(1, 'CA20180829164956', '2018-08-29 16:49:56', 1, 480, 80, 'HEIDI KUO', '02-26687279', '0952056917', '23853', '新北市', '樹林區', '學勤路326號26樓', '', '信用卡', '超商取貨', '2018-08-29 16:50:06', NULL, 0, '');
...
--
ALTER TABLE `customer_orders`
  MODIFY `customer_orders_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
