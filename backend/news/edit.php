...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
  $sql= "UPDATE  news  SET
            ...
            title=:title,
            content=:content,
            updated_at=:updated_at  WHERE  news_id=:news_id" ;
  $sth = $db ->prepare($sql);
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-right">
        ...
        <div class="row">
        <div class="col-md-12">
        <form class="mx-auto w-88" action="edit.php?news_id=<?php echo $news['news_id'];?>" method="post">
        <div class="form-group form-row">
            <label class="col-sm-2 col-form-labelt">發布日期</label>
            <div class="col-sm-10 text-left">
              <input type="text" id="published_date" class="form-control"  placeholder="輸入日期" name="published_date" value="<?php echo $news['published_date'] ?>"> </div>
          </div>
          <div class="form-group form-row">
            <label class="col-sm-2 col-form-label">標題</label>
            <div class="col-sm-10 text-left">
              <input type="text" class="form-control" placeholder="輸入標題" name="title" value="<?php echo $news['title'] ?>"> </div>
          </div>
          <div class="form-group form-row">
            <label class="col-sm-2 col-form-label">消息內容</label>
            <div class="col-sm-10 text-left">
              <textarea type="text" class="form-control" name="content" placeholder="輸入內容 至少300個字" cols="70" maxlength="800" rows="8"><?php echo $news['content'] ?></textarea>
            </div>
          </div>
          <div class="col-md-12 text-right">
