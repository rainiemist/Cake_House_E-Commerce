      ...
      <div class="col-md-12 text-right">
        ...
        <div class="form-group form-row">
            ...
            <div class="col-sm-10 text-left">
              <input type="text" id="created_at" class="form-control"  placeholder="新增日期" name="created_at"> </div>
          </div>
          <div class="form-group form-row">
            <label class="col-sm-2 col-form-label">頁面抬頭</label>
            <div class="col-sm-10 text-left">
              <input type="text" class="form-control" placeholder="輸入抬頭名稱" name="title"> </div>
          </div>
          <div class="form-group form-row">
            <label class="col-sm-2 col-form-label">頁面內容</label>
            <div class="col-sm-10 text-left">
              <textarea type="text" class="form-control" name="content" placeholder="輸入頁面內容 至少300個字" cols="70" maxlength="800" rows="8"></textarea>
            </div>
          </div>
          <div class="col-md-12 text-right">
